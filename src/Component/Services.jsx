                ...
                {list.map((item)=>(
                     ...
                     <div className='shadow-md hover:bg-[#FFF5EF]  text-center p-3 rounded-md mt-3 portResImg'>
                         ...
                         <div className='flex justify-center'>
                            {item.showImg ?  <img className='img-fluid py-3' src={`https://dainamic-portfolio-backend-git-main-md-shahadat-alams-projects.vercel.app/${item.serImg}`} alt="images" /> : <div className='w-[83px] h-[83px] bg-slate-200 d-flex align-items-center justify-center'> No Img</div>}
